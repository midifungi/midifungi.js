 ...
 */
 function onSettings (menu) {
  ...
  menu.general.addInput(this.store, 'tileSize', {
    min: 128,
    max: 512,
    step: 128
  }).on('change', ev => {
...
function recenter () {
  ...
  webglCanvas.position(windowWidth / 2 - width / 2, windowHeight / 2 - height / 2, 'fixed')
  depthMap.position(windowWidth / 2 - width / 2, windowHeight / 2 - height / 2, 'fixed')
}
...
function windowResized () {
  ...
  depthMap.resizeCanvas(width, height)
  setupScene()
}
