 ...
 * @constructor
 */
window.WaterCanvas = function(width, height, documentElement, waterModel, props) {
 ...
 * @constructor
 */
window.WaterModel = function(width, height, props) {
	// If a certain property is not set, use a default value
	props = props || {};
 ...
 */
window.RainMaker = function(width, height, waterModel, raindrop2dArray) {
	this.width = width;
	this.height = height;
	this.waterModel = waterModel;
